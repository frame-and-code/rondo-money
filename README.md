...
Phase 2 is next: validated input at the API boundary, and money that takes its number of
minor digits from the budget's currency. The budgeting model itself is not built yet.
