...
export const pl: Record<MessageKey, string> = {
  ...
  'categories.reorderGroup': 'Przestaw grupę {{group}}',
  'categories.emptyGroupAdd': 'Dodaj kategorię',
  'categories.paidClose': 'Zamknij w tym miesiącu',
  'categories.paidReopen': 'Otwórz ponownie',
  'categories.paidTitle': 'Zamknąć kategorię {{category}} w tym miesiącu?',
  'categories.paidBody':
    'Karta stanie się półprzezroczysta i przejdzie na koniec grupy. Pieniądze w niej zostaną, kwoty się nie zmienią. W następnym miesiącu kategoria znów jest otwarta.',
  'categories.paidConfirm': 'Tak, zamknij',
  'categories.paidMark': 'Zamknięta w tym miesiącu',
  'categories.overspentCount': 'Kategorie poniżej zera: {{count}}',
  'categories.overspentShow': 'Pokaż tylko je',
  'categories.overspentShowAll': 'Pokaż wszystkie',
