...
export const pl: Record<MessageKey, string> = {
  ...
  'categories.readyToAssignFree': 'Te pieniądze nie mają jeszcze zadania',
  'categories.readyToAssignDone': 'Wszystko rozdysponowane',
  'categories.readyToAssignOver': 'Rozdysponowano więcej, niż jest na kontach',
  ...
  'categories.assigned': 'przydzielono',
