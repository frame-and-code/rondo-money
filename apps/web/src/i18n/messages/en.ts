...
export const en: Record<MessageKey, string> = {
  ...
  'categories.readyToAssign': 'Ready to assign',
  'categories.readyToAssignFree': 'This money has no job yet',
  'categories.readyToAssignDone': 'Every unit has a job',
  'categories.readyToAssignOver': 'More is assigned than the accounts hold',
