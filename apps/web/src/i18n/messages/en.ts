...
export const en: Record<MessageKey, string> = {
  ...
  'accounts.actionsFor': 'What can be done with {{name}}',
  ...
  'accounts.archiveNeedsZero': 'Locked while it holds money',
  ...
  'accounts.reconcile': 'Reconcile the balance',
  'accounts.reconcileTitle': 'Reconcile {{name}}',
  'accounts.reconcileBody':
    'Say what the account really holds. We write the one record that makes the book agree, and that money joins or leaves Ready to Assign.',
  'accounts.reconcileLabel': 'What the account really holds',
  'accounts.reconcileComputed': 'The book says',
  'accounts.reconcileWillWrite': 'Records a correction of {{amount}}, dated today.',
  'accounts.reconcileNoDifference': 'The two already agree, so nothing is recorded.',
  ...
  'transactions.adjustment': 'Reconciliation',
  'transactions.adjustmentBadge': 'correction',
  ...
  'transactions.typeAdjustment': 'Corrections',
