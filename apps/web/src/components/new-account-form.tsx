...
/// Long enough to read the one line under it, short enough that nobody waits for it. The
/// account already exists by then; this is the only place the screen says so.
